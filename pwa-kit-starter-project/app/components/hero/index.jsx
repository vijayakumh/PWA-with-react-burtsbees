...
const Hero = ({title, imgDesktop, imgMobile, imgTablet, actions, ...props}) => {
    const {srcDesktop, altDesktop} = imgDesktop
    const {srcMobile, altMobile} = imgMobile
    const {srcTablet, altTablet} = imgTablet
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box position={'relative'} width={{base: 'full', md: 'full', lg: 'full'}}>
                    <Image
                        fit={'cover'}
                        align={'center'}
                        width={'100%'}
