    ...
    return (
        ...
        >
            ...
            <Hero
                ...
                imgDesktop={{
                    srcDesktop: getAssetUrl('static/img/burtsherodesktop.jpg'),
                    altDesktop: 'npx pwa-kit-create-app'
                }}
                imgMobile={{
                    srcMobile: getAssetUrl('static/img/burtsheromobile.jpg'),
                    altMobile: 'npx pwa-kit-create-app'
                }}
                imgTablet={{
                    srcTablet: getAssetUrl('static/img/burtsherotablet.jpg'),
                    altTablet: 'npx pwa-kit-create-app'
                }}
                actions={
